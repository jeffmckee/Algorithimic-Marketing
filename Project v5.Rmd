...
#for test set, turn campaign into dummy variables, remove observations with campaign >5 for model estimates
...
#expand train data, turn campaigns into dummies, create model matrix
