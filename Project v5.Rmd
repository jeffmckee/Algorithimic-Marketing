...
## WNS: I think we can do this more efficiently: 
x_matrix2 <- model.matrix(Class~.*(campaign2+campaign3+campaign4+campaign5)-campaign2*(campaign3+campaign4+campaign5)-campaign3*(campaign4+campaign5)-campaign4*campaign5-1,data=model_df)
...
barplot(c(baseline_profit,two_call_profit,three_call_profit,logit_profit,lasso_profit))
