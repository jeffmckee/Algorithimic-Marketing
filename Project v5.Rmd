...
```{r}
#KNN stuff - attempt at using knnGarden package

#install.packages("knnGarden")
library(knnGarden)

#subset for dev purposes
sub_df <- full_df[1:10000,]

TrnX <- sub_df[campaign_no <=5,c(58:61,1,17,23)]
# campaign dummies; age; retired; student
#TrnX <- sub_df[campaign_no <=5,c(1,17,23)]

OrigTrnGdf <- sub_df[campaign_no <=5,54]
OrigTrnG <- OrigTrnGdf$Class

#TstX <- sub_df[campaign_no <=5 & Class==FALSE,54]
sub_TstX <- full_df[20000:25000]
