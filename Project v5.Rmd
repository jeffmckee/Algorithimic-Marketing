...
for (i in 1:20){
  ...
  print(paste("total calls:",sum(nn$call)))
  print(paste("good calls:",length(nn$match[nn$match==TRUE])))
  print(paste("total profit:",sum(nn$profit) - sum(nn$failcost)))
  print(paste("----------"))
}
...
library(pvclass)
knnout <- cvpvs.knn(TrnX, OrigTrnG, k = 1, distance = 'mahalanobis', cova = 'standard')
```