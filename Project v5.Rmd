...
( expected_profit_tree <- -fail_cost*sum(fail_calls_tree) + Success_profit*sum(success_calls_tree>0) )
...
( expected_profit_rf <- -fail_cost*sum(fail_calls_rf) + Success_profit*sum(success_calls_rf>0) )
...
( expected_profit_gbm <- -fail_cost*sum(fail_calls_gbm) + Success_profit*sum(success_calls_gbm>0) )
