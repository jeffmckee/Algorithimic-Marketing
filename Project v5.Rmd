...
test_reg <- glm(outcome~campaign2+campaign3+campaign4+campaign5 +age + job_retired + job_student+job_housemaid +marital_divorced,data=full_df[campaign_no <= 5],family="binomial")
summary(test_reg)
...
#Insert code on profitability

}
hist(df_test$Max_calls[df_test$ID<=8238])
