...
test_reg <- glm(outcome~campaign2+campaign3+campaign4+campaign5,data=full_df[campaign_no <= 5],family="binomial")
summary(test_reg)
...
#Profit from successful customer: According to a paper, CD rates in the Netherlands average ~60% of Euribor rates (https://onlinelibrary.wiley.com/doi/full/10.1111/irfi.12143)
          Market_rate <-sample_person$euribor3m / 100 
...
Compute_Sample_Profitability(77510)
